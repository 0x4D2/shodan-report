...
snap = Path('snapshots/TestCustomer/2026-01_1.2.3.4.json')
if not snap.exists():
...
management_text = 'Automatisch generierter Testbericht (Snapshot TestCustomer)'
...
out = generate_pdf(
    ...
    output_dir=Path('reports/demo/TestCustomer'),
)
print('Wrote PDF:', out)

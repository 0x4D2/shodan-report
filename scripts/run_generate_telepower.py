...
snap = Path('snapshots/TelePower_GmbH_&_Co._KG/2026-02_87.129.151.186.json')
if not snap.exists():
...
customer = 'TelePower GmbH & Co. KG'
month = '2026-02'
ip = technical_json.get('ip', 'unknown')
management_text = 'Automatisch regenerierter Bericht (Snapshot TelePower)'
...
out = generate_pdf(
    ...
    evaluation={},
    business_risk='high',
    output_dir=Path('reports/demo/TelePower'),
)
print('Wrote PDF:', out)

...
class ReportArchiver:
    ...
    def archive_report(self, pdf_path: Path, customer_name: str, month: str, ip: str, extra_metadata: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    def find_previous_report(self, customer_name: str, month: str, 
        ...
        previous_months = sorted([
            d.name for d in customer_dir.iterdir() 
                ...
                if month_dir.is_dir() and self._is_valid_month(month_dir.name):
                    ...
                    if month_reports:
                        reports.append({
                            ...
                            "reports": sorted(month_reports, key=lambda x: x.get("created_at", ""), reverse=True)
                        })
    ...
    def _create_metadata(self, pdf_path: Path, customer_name: str, customer_slug: str, month: str, ip: str, version: int, extra_metadata: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    def _save_metadata(self, target_dir: Path, base_filename: str, metadata: Dict[str, Any], version: int) -> None:
    ...
    def _manual_get_next_version(self, customer_slug: str, month: str, 
                           base_filename: str) -> int:

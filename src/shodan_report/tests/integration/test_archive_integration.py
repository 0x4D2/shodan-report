...
def test_full_report_flow_with_archive(tmp_path):
    ...
    with (
        patch("shodan_report.core.runner.ShodanClient") as mock_client,
        patch(
            "shodan_report.core.runner.parse_shodan_host", return_value=mock_snapshot
        ),
        patch(
            "shodan_report.core.runner.generate_management_text",
            return_value=mock_management_text,
        ),
        patch("shodan_report.core.runner.analyze_trend", return_value=mock_trend_text),
        patch(
            "shodan_report.core.runner.build_technical_data",
            return_value=mock_technical_json,
        ),
        ...
        with patch(
            "shodan_report.core.runner.ReportArchiver", return_value=real_archiver
        ):

...
def test_archive_report_basic(tmp_path):
    ...
    # Dateien existieren
    expected_pdf = tmp_path / "archive" / "test_company" / "2025-01" / "2025-01_1.2.3.4_v1.pdf"
    expected_meta = tmp_path / "archive" / "test_company" / "2025-01" / "2025-01_1.2.3.4.meta.json"
...
def test_invalid_month_format(tmp_path):
    ...
    with pytest.raises(ValueError):
        archiver.archive_report(pdf_path, "Test", "2025-13", "1.2.3.4")  # Ungültiger Monat
...
def test_archive_report_slug_consistency(tmp_path):
    ...
    for customer_name, expected_slug in test_cases:
        ...
        assert expected_dir.exists(), f"Verzeichnis für {customer_name} sollte existieren"

...
class TestGeneratePriorityInsights:
    ...
    def test_empty_technical_json(self, mock_evaluation):
        ...
        assert insights == ['Keine kritischen Schwachstellen', '0 kritische Risikopunkte']
    
    def test_with_open_ports(self, mock_evaluation, sample_service):
        """Test mit offenen Ports."""
        technical_json = {
            "open_ports": [sample_service, sample_service]  # 2 Dienste
        }
...
class TestGeneratePriorityRecommendations:
    ...
    def test_base_recommendations_high(self):
        ...
        assert "Priorisierte Maßnahmen" in recommendations[0]
    ...
    def test_base_recommendations_medium(self):
        ...
        assert "Geplante Maßnahmen" in recommendations[0]
        assert "30 Tagen" in recommendations[0]
    ...
    def test_ssh_service_recommendation(self):
        ...
        assert any("SSH" in rec and "Schlüsselbasierte" in rec for rec in recommendations)
    ...
    def test_rdp_service_recommendation(self):
        ...
        assert any("RDP" in rec and "Netzwerk-Level-Authentifizierung" in rec for rec in recommendations)
...
class TestManagementHelpersIntegration:
    ...
    def test_complete_workflow(self):
        ...
        evaluation = Evaluation(
            ip="192.168.1.1",
            risk="MEDIUM",
            critical_points=["SSH exposed without VPN"]
        )
